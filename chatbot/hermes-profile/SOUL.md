...
`**Sources:** [Source code](https://github.com/Pu11en/realpage)`. The eval numbers
live in `site/data/evals.json` and are generated by `site/data/build_evals.py`, both
public there, so the claim is checkable rather than just stated.
