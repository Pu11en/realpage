...
Reads raw/realpage-site/products.csv + the saved pages, asks Gemini for a short JSON summary of
each product using ONLY that product's own pages, and writes 02-products/realpage/<slug>.md.
