# Masiate: Is The Research Useful?
...
Replace the headline "Top Properties" with **"Masiate Opportunity Review: What Is Known And What Still Needs Checking"**.

Each reviewed project gets one clear status, grounded in dated evidence:
...
clue, not proof that the owner is still soliciting bids today.

### What Each Useful Profile Must Say

- **What work is actually described?** Separate the source wording from our inference about Masiate's fit.
- **What could Masiate do?** Name the relevant service; do not assume its crew size, bonding, commercial qualifications or capacity from its website.
- **Who would be buying that work?** Owner, tenant or main contractor, with the role established or explicitly unknown.
- **Is someone already named for that exact work?** Give the contractor evidence, or say unknown.
- **What makes this worth checking?** A concrete reason, not just a large project budget or recent registration.
- **What is the business contact route?** Identify the source and whether it reaches a buyer, designer, contractor or general office; no personal homeowner contact details.
- **What single missing fact determines the next step?** For example, whether the tenant still needs a main contractor, rather than a generic instruction to research more.
- **How old is the evidence?** Show both the source date and check date, distinguish estimated from actual construction dates, and disclose reporting gaps.

## Examples From Work Already Saved

### Citizens National Bank: Not An Unassigned Main-Contractor Lead
...
- All three describe renovation or interior finish-out work, but the follow-up did not establish contractor selection for the exact projects.
- Galaxy Spa's detailed Bryan search was inaccessible; this is a coverage gap, not evidence that no contractor exists.
- Glo's project is tenant-funded; the property owner must not automatically be treated as the person buying the buildout.
- Barron contractor matches for other suites were excluded; Suite 204 remains unresolved.
- College Station's available September spreadsheet stopped at September 11, leaving a gap before our September 20 check.
- Useful result: three specific projects to qualify, with precise missing facts, instead of three claimed available jobs.
- Full follow-up evidence is preserved in `docs/research/masiate-contractor-check-20260920.md` and must be incorporated without changing the original report's date or pretending all 49 profiles were rechecked live.

### North And Dunn Apartments: A Bid Clue To Verify

- Saved planning evidence includes wording about drawings issued for bidding.
- That is more relevant to procurement than project size alone, but the saved review did not establish an active invitation, deadline, unawarded main contract, or Masiate's capacity for the full project.
- Keep it as a **bid-status verification candidate**, not a confirmed open job.

## A Small Revision, Not Another Collection Run

### Pass 1: Audit The Existing Profiles

- Review the 49 published profiles, their saved supporting evidence and the completed three-property follow-up.
- Reuse the original collection, reviewer decisions, contact checks and coverage notes; do not crawl new sources or buy data.
- Record one classification with its supporting source and uncertainty for every profile, retaining separate suites, phases and scopes.
- Use older/raw saved records only to clarify these profiles; do not imply the other collected entries were all deeply reviewed. The pilot explicitly left 98 additional Brazos registrations without deep review.
- Calculate the category totals and usable buyer-contact counts from the audit, not from a target number of leads.
...
- Do not inflate the document to match the original 63 pages; detail should earn its space.

### Pass 3: Check And Deliver A Separate Revision
