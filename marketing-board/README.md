...
A one-page posting shelf for finished CraneSignal posts. The first screen is only platforms; click a platform to see the ready assets for that platform.
...
- Each post can have parts like `caption`, `title`, `description`, `reply`, `message`, `subject`, or `firstComment`.
